...
app.controller('CountdownCtrl', ['$scope', function($scope){
  ...
  $scope.finished = function() {
    // insert vacation text
    var vacationMsg = '<h1>' + 'AB GEHTS!!!' + '</h1>';
    var vacationText = document.getElementById('vacationText')
    vacationText.innerHTML = vacationMsg;
    vacationText.style.textAlign = 'center';
    vacationText.style.fontFamily = 'Roboto';
    vacationText.className = 'animated fadeIn';
    ...
    setTimeout(function(){
      var fireworks = '<canvas id="canvas">' + 'Canvas is not supported by your browser.' + '</canvas>'
      countdownWrapper.innerHTML += fireworks;
